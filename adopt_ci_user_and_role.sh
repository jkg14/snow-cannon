...
TOKEN=$(eval aws sts assume-role --role-arn "arn:aws:iam::$AWS_ACCOUNT_ID:role/glasgow-cannon-2-ci-deployment-role-dev" --role-session-name AWSCLI-Session --duration-seconds 900)
